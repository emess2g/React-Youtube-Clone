...
const PlayVideo = () => {
    ...
    const fetchVideoData = async ()=>{
        // fetch video data
        const videosDetail_url = ` https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&id=${videoId}&key=${API_KEY}`;
        await fetch(videosDetail_url).then(res=>res.json()).then(data=> setApiData(data.items[0]));
    }
    ...
    <div className='play-video'>
      ...
      <div className="play-video-info">
        ...
        <div className="">
            ...
            <span><img src={dislike} alt="" />39</span>
